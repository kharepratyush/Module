...
AWS.config.update({ accessKeyId: 'XXXXXXXXXXXXXXXXXXXXXX', secretAccessKey: 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX' });
...
router.get('/question/:id', function(req, res){
	...
	connection.query('SELECT answer,vote_count,project_answer_id,user_id FROM project_answer WHERE project_question_id = ?',[id], function(err, fields){
		if(err)
